...
const LeftSidebar = ({ profile, currentColor }) => {
  ...
  return (
    <div className="fixed left-8 top-8 z-40">
      {/* Profile Card */}
      <div className="bg-gray-800 rounded-2xl p-10 shadow-2xl border border-gray-700 w-80">
        {/* Profile Picture */}
        <div className="text-center mb-8">
          <div className="w-36 h-36 mx-auto mb-6 rounded-full overflow-hidden border-4 border-gray-600">
            <img 
              src={profile.image} 
              alt={profile.name}
        ...
        {/* Hire Me Button */}
        <button
          className="w-full py-4 text-white font-semibold rounded-lg transition-all duration-200 hover:scale-105 shadow-lg text-sm"
