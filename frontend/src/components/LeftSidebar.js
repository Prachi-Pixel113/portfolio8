...
const LeftSidebar = ({ activeSection, onSectionClick, onSettingsClick, profile, currentColor }) => {
  ...
  return (
    <>
      ...
      {/* Left Sidebar */}
      <div className={`fixed left-0 top-0 h-full w-80 bg-gray-800 border-r border-gray-700 transform transition-transform duration-300 ease-in-out z-40 ${
        isMobileOpen ? 'translate-x-0' : '-translate-x-full'
      } lg:translate-x-0 flex flex-col`}>
        
        {/* Profile Block */}
        <div className="p-8 text-center border-b border-gray-700 flex-shrink-0">
          {/* Profile Picture */}
        ...
        <div className="p-4 border-t border-gray-700">
          <button
            ...
            className="w-full flex items-center justify-center px-6 py-4 bg-gray-700 hover:bg-gray-600 text-gray-300 hover:text-white rounded-xl transition-all duration-200 group"
          >
          ...
          <div className="flex justify-center space-x-4">
            {socialLinks.map((social) => (
              <a
                ...
                className="w-10 h-10 flex items-center justify-center bg-gray-700 rounded-full hover:shadow-lg transition-all duration-200"
                style={{
