...
const LeftSidebar = ({ profile, currentColor }) => {
  ...
  return (
    <div className="fixed left-8 top-8 z-40">
      {/* Profile Card */}
      <div className="bg-gray-800 rounded-2xl p-12 shadow-2xl border border-gray-700 w-80">
        {/* Profile Picture */}
        <div className="text-center mb-10">
          <div className="w-40 h-40 mx-auto mb-8 rounded-full overflow-hidden border-4 border-gray-600">
            <img 
              src={profile.image} 
              alt={profile.name}
        ...
        {/* Contact Info */}
        <div className="text-center mb-10">
          <p className="text-white text-sm mb-3">{profile.email}</p>
        ...
        {/* Hire Me Button */}
        <button
          className="w-full py-5 text-white font-semibold rounded-lg transition-all duration-200 hover:scale-105 shadow-lg text-sm"
